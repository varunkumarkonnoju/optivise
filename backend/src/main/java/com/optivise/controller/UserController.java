    ...
    public ResponseEntity<Map<String, Object>> updateMe(
        ...
        try {
            ...
            if (body.containsKey("shopDomain") && !body.get("shopDomain").isBlank()) {
                ...
                if (!domain.contains(".myshopify.com")) domain = domain + ".myshopify.com";
                user.setShopDomain(domain);
            }

            if (body.containsKey("shopifyAccessToken") && !body.get("shopifyAccessToken").isBlank())
                user.setShopifyAccessToken(body.get("shopifyAccessToken").trim());
